...
namespace QuanLyLopTinChi
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jquerymins").Include(
            ...
            // Slide js 
            bundles.Add(new StyleBundle("~/bundles/jquerySlide").Include(
                   "~/Scripts/js-image-slider.js",
                   "~/Scripts/jquery-1.4.1.min.js",
                   "~/Scripts/jquery-1.4.1.js",
                   "~/Scripts/jquery-1.4.1-vsdoc.js"));
            // Slide css 
            bundles.Add(new StyleBundle("~/bundles/cssSlide").Include(
